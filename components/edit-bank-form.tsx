...
interface EditBankFormProps {
  isOpen: boolean
  onClose: () => void
  onSave: (bankData: BankAccount) => void
...
export default function EditBankForm({ isOpen, onClose, onSave, bankAccount }: EditBankFormProps) {
  ...
  useEffect(() => {
    if (bankAccount) {
      setFormData({
        ...
        accountNumber: bankAccount.accountNumber.replace(/X/g, ""), // Remove masking for editing
        confirmAccountNumber: bankAccount.accountNumber.replace(/X/g, ""),
